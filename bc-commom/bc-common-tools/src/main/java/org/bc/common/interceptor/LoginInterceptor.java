...
import org.bc.common.vo.AppResult;
import org.bc.common.vo.Constant;
import org.bc.common.vo.LoginParm;
import org.bc.common.vo.RedisKey;
import org.bc.common.vo.ReturnWrapper;
import org.bc.common.vo.UserSession;
...
public class LoginInterceptor {
	 ...
	 * NoNeedToLogin 注解
	 */
	@Pointcut("execution(* com.ikang.saas.*.*.controller..*(..)) "
			+ "&& @annotation(org.springframework.web.bind.annotation.RequestMapping) "
			+ "&& !@annotation(org.bc.common.annotation.NoNeedToLogin)")
	...
	@Pointcut("@annotation(org.bc.common.annotation.UserLogin)")
